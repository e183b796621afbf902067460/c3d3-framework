...
class iDexSupplyScreenerHandler(iHandler):
    ...
    _TOKEN_ADDRESS_COLUMN = 'token_address'
    ...
    class Builder:
        ...
        @overload
        def build(self, params: Dict[str, Any]) -> "iDexSupplyScreenerHandler.Builder":
            ...

        @overload
        def build(self, key: str, value: Any) -> "iDexSupplyScreenerHandler.Builder":
            ...
        ...
        ) -> "iDexSupplyScreenerHandler.Builder":
