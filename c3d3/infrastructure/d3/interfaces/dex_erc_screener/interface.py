...
class iDexERCScreenerHandler(iHandler):
    ...
    class Builder:
        ...
        @overload
        def build(self, params: Dict[str, Any]) -> "iDexERCScreenerHandler.Builder":
            ...

        @overload
        def build(self, key: str, value: Any) -> "iDexERCScreenerHandler.Builder":
            ...
        ...
        ) -> "iDexERCScreenerHandler.Builder":
