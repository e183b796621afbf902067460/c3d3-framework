...
from c3d3.infrastructure.d3.handlers.dex_screener.uniswap.v3.handler import UniSwapV3DexScreenerHandler, _UniSwapV3DexScreenerHandler
...
DexScreenerFactory.add_object(k=_UniSwapV3DexScreenerHandler.key, v=_UniSwapV3DexScreenerHandler)
